...
import linkedinBackground from "../../assets/linkedin.png";
  ...
  return (
    <div className="h-[40rem] w-full flex flex-col items-center justify-center mt-10 ">
      ...
      <div className="flex flex-wrap gap-6 justify-center my-8 sm:mb-5">
        ...
        <PinContainer
          title="LinkedIn"
          href="https://www.linkedin.com/in/tushar-jain-9b4934257/"
          className="mb-6 sm:mb-0"
        >
          <div
            className="flex flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] h-[20rem] relative group"
            style={{ boxShadow: "0 0 20px 10px rgba(0, 119, 181, 0.5)" }}
          >
            <FaLinkedin className="absolute top-4 right-4 text-white text-4xl" />
            ...
            <div
              className="flex flex-1 w-full rounded-lg mt-4 bg-cover bg-center relative group-hover:shadow-lg group-hover:shadow-blue-400/50 transition-all duration-300"
              style={{ backgroundImage: `url(${linkedinBackground})` }}
            >
              <FaLinkedin className="absolute bottom-4 left-4 text-white text-3xl" />
            </div>
          </div>
        </PinContainer>
        ...
        >
          <div
            className="flex flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] h-[20rem] relative group"
            style={{ boxShadow: "0 0 20px 10px rgba(128, 0, 128, 0.5)" }}
          >
            ...
            <div className="text-base !m-0 !p-0 font-normal">
              <span className="text-slate-500">Stores my Projects</span>
            </div>
            <div
        ...
        <PinContainer
          title="LeetCode"
          href="https://leetcode.com/u/bytewizard123/"
          className="sm:mt-5"
        >
          <div
            className="flex flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] h-[20rem] relative group"
            style={{ boxShadow: "0 0 20px 10px rgba(0, 0, 255, 0.5)" }}
          >
            ...
            <div className="text-base !m-0 !p-0 font-normal">
              <span className="text-slate-500">DSA Companion</span>
            </div>
            <div
